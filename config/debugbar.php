...
return [
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | Debugbar is enabled by default, when debug is set to false in app.php.
     | You can override the value by setting enable to false or false instead of null.
     |
    ...
    /*
     ...
     | So if you want syntax highlighting, set it to false.
